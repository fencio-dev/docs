...
See the [OpenTelemetry Ingestion](/patterns/otel-ingestion) pattern for details on receiving OTLP data as input to AARM's Action Mediation Layer.
...
<CardGroup cols={2}>
  ...
  <Card title="OpenTelemetry Ingestion" icon="arrow-right-to-bracket" href="/patterns/otel-ingestion">
    Ingest agent OTLP data as AARM input
  </Card>
</CardGroup>
